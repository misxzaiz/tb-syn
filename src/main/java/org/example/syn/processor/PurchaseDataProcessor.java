...
@Component
public class PurchaseDataProcessor implements DataProcessor<TbPurchaseInDTO> {
    ...
    public PageDTO<TbPurchaseInDTO> page(PageReqDTO req) {
        ...
        // 生成模拟数据
        List<TbPurchaseInDTO> dataList = generateMockData(startIndex, endIndex, req);
...
//        }
        List<TbPurchaseInDTO> dataList = new ArrayList<>();
        ...
        for (int i = startIndex; i < endIndex; i++) {
            TbPurchaseInDTO dto = new TbPurchaseInDTO();
